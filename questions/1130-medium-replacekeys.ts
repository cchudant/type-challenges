...
type IndexOrNever<O, K extends keyof any> = K extends keyof O ? O[K] : never
type ReplaceKeys<U, T extends keyof any, Y> =
    U extends U
        ? ([Extract<T, keyof U>] extends [keyof U]
            ? Simplify<Omit<U, Extract<T, keyof U>> & { [K in Extract<T, keyof U>]: IndexOrNever<Y, K> }>
            : U)
        : never
